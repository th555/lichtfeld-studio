...
namespace lfs::project {
    ...
    struct DataSetInfo : public lfs::core::param::DatasetConfig {
        std::string data_type;
        DataSetInfo() = default;
        explicit DataSetInfo(const lfs::core::param::DatasetConfig& data_config);
    };
    ...
    public:
        ...
        void setOptimizationParams(const lfs::core::param::OptimizationParameters& opt) { project_data_.optimization = opt; }
        [[nodiscard]] lfs::core::param::OptimizationParameters getOptimizationParams() const { return project_data_.optimization; }

        // Convenience methods
        void setProjectName(const std::string& name);
        void setDataInfo(const lfs::core::param::DatasetConfig& data_config);
    ...
    std::shared_ptr<Project> CreateNewProject(const lfs::core::param::DatasetConfig& data, const lfs::core::param::OptimizationParameters& opt,
                                              const std::string& project_name = "LichtFeldStudioProject", bool update_file_on_change = true);

    std::shared_ptr<Project> CreateTempNewProject(const lfs::core::param::DatasetConfig& data, const lfs::core::param::OptimizationParameters& opt,
                                                  const std::string& project_name = "LichtFeldStudioProject", bool update_file_on_change = true);
